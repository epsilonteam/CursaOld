...
import club.eridani.cursa.utils.CrystalUtil;
...
@Module(name = "OffHandCrystal", category = Category.COMBAT)
public class OffHandCrystal extends ModuleBase {

    Setting<String> mode = setting("Item", "Crystal", listOf("Gap", "Crystal"));
