...
public class CursaTessellator extends Tessellator {
    public static CursaTessellator INSTANCE = new CursaTessellator();

    public CursaTessellator() {
        super(2097152);
    }

    public static void prepare(int mode) {
        CursaTessellator.prepareGL();
        CursaTessellator.begin(mode);
    }
    ...
    public static void drawBox(BlockPos blockPos, int argb, int sides) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        CursaTessellator.drawBox(blockPos, r, g, b, a, sides);
    }

    public static void drawBox(BlockPos blockPos, int r, int g, int b, int a, int sides) {
        CursaTessellator.drawBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void drawFullBox(BlockPos pos, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        CursaTessellator.drawFullBox(pos, width, r, g, b, a);
    }
    ...
    public static void drawBoundingBox(BlockPos bb, float width, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        CursaTessellator.drawBoundingBox(bb, width, r, g, b, a);
    }
