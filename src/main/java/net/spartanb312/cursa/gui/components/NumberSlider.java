...
import net.spartanb312.cursa.setting.settings.DoubleSetting;
import net.spartanb312.cursa.setting.settings.FloatSetting;
import net.spartanb312.cursa.setting.settings.IntSetting;
